        ...
        <div className="boo">
            ...
            filter.map((item)=>(
                <div className="container" key={item.id}>
                    ...
                    <img src={item.pic2}  onClick={() => setSelectedImg(item.pic2)}/>
                    <img src={item.pic3}  onClick={() => setSelectedImg(item.pic3)}/>
                    <img src={item.pic4}  onClick={() => setSelectedImg(item.pic4)}/>
                    <img src={item.pic5}  onClick={() => setSelectedImg(item.pic5)}/>
                    <img src={item.pic6}  onClick={() => setSelectedImg(item.pic6)}/>
                    <img src={item.pic7}  onClick={() => setSelectedImg(item.pic7)}/>
